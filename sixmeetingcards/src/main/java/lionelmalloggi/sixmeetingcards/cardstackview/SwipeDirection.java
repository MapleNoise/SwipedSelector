...
public enum SwipeDirection {
    ...
    public static final List<SwipeDirection> FREEDOM = Arrays.asList(SwipeDirection.values());
    public static final List<SwipeDirection> FREEDOM_NO_BOTTOM = Arrays.asList(SwipeDirection.Top,SwipeDirection.Left, SwipeDirection.Right);
